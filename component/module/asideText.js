...
export default function AsideText(){
    ...
    return (
        <>
            ...
            <a className={path == '/dashboard/myAdv' ? 'aside-focus' : null} href="/dashboard/myAdv">اگهی های من</a>
            <a className={path == '/dashboard/add' ? 'aside-focus' : null}href="/dashboard/add">ثبت اگهی</a>
